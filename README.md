...
This code base is to write all the code needed for education purposes and to run small experiments to learn about different topics in mmechanistic interpretability
